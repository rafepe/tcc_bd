# Generated by Django 4.2.22 on 2025-06-30 19:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='declaracao_contrapartida_equipamento',
            fields=[
        ...
        migrations.CreateModel(
            name='declaracao_contrapartida_equipamento_item',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='declaracao_contrapartida_rh',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_projeto', models.IntegerField(verbose_name='Projeto Id')),
                ('projeto', models.CharField(max_length=255, verbose_name='Projeto')),
        ...
        migrations.CreateModel(
            name='declaracao_contrapartida_rh_item',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=255, verbose_name='Nome do Bolsista')),
                ('cpf', models.CharField(max_length=14, verbose_name='CPF')),
                ('funcao', models.CharField(default='Prospector', max_length=100, verbose_name='Função')),
        ...
        migrations.CreateModel(
            name='declaracao_contrapartida_so',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_projeto', models.IntegerField(verbose_name='Projeto Id')),
                ('projeto', models.CharField(max_length=255, verbose_name='Projeto')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('id_projeto', 'mes', 'ano'), name='unique_declaracao_so_por_projeto_mes_ano'),
        ),
        migrations.AddField(
            model_name='declaracao_contrapartida_rh_item',
            name='declaracao',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itens', to='declaracao.declaracao_contrapartida_rh', verbose_name='Declaração'),
        ),
        migrations.AddConstraint(
            model_name='declaracao_contrapartida_rh',
            constraint=models.UniqueConstraint(fields=('id_projeto', 'mes', 'ano'), name='unique_declaracao_rh_por_projeto_mes_ano'),
        ),
        migrations.AddField(
            model_name='declaracao_contrapartida_pesquisa_item',
            name='declaracao',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itens', to='declaracao.declaracao_contrapartida_pesquisa', verbose_name='Declaração'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddField(
            ...
            name='declaracao',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itens', to='declaracao.declaracao_contrapartida_equipamento', verbose_name='Declaração'),
        ),
        migrations.AddConstraint(
            model_name='declaracao_contrapartida_equipamento',
            constraint=models.UniqueConstraint(fields=('mes', 'ano'), name='unique_declaracao_equipamento_mes_ano'),
        ),
        migrations.AddConstraint(
            model_name='declaracao_contrapartida_rh_item',
            constraint=models.UniqueConstraint(fields=('declaracao', 'cpf'), name='unique_item_rh_por_declaracao_e_cpf'),
        ),
        migrations.AddConstraint(
            model_name='declaracao_contrapartida_pesquisa_item',
        ...
        migrations.AddConstraint(
            model_name='declaracao_contrapartida_equipamento_item',
            constraint=models.UniqueConstraint(fields=('declaracao', 'equipamento', 'projeto'), name='unique_item_por_declaracao_equipamento_projeto'),
        ),
    ]
