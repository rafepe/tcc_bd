"""
Django settings for prestaconta project.
...
SECRET_KEY = 'django-insecure-n=^9h74_t4r1@1i-d@l-u&b^zf%0h1+hr7f%d4$0oo6)lwq=k!'
...
MIDDLEWARE = [
    'contrapartida.log_ip_middleware.LogIPMiddleware',  #middleware para log de IP
...
WSGI_APPLICATION = 'prestaconta.wsgi.application'
